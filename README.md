...
- **Mac:** alpha available: 129 Homebrew apps, tools and fonts across 13 categories, plus guided source-project and browser add-on setup, installed markers, one review basket, Homebrew updates, a built-in checker and verified updater for Magus releases, six reversible Finder preferences, and portable setups for Ghostty, Zed, Firefox, Zsh, and Raycast. See [build and test instructions](magus/MAC.md). The installer supports Apple silicon and Intel release assets.
